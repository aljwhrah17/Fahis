...
* Explainability: Explainable AI (XAI) for generating transparent, automated compliance reports[span_5](start_span)[span_5](end_span).
* Frontend/Backend: React, Vite, Python, and secure APIs[span_6](start_span)[span_6](end_span).

## ⚙️ Key Capabilities
1. Complex Relationship Tracking: Uncovers indirect links, shell companies, and hidden beneficial ownerships[span_7](start_span)[span_7](end_span).
2. False Positives Reduction: Advanced AI classification minimizes false alarms, reducing investigation time from hours to seconds[span_8](start_span)[span_8](end_span).
